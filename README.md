...
單次僅一位學生。後續加入分數、點數等學生資料時，須同步擴充此刪除工作流與真正刪除回歸測試；目前尚無這些模組。本次無新增 migration。
...
3. 導師按「重新整理教師」，對待審申請選「批准」或「拒絕」。批准後該班出現在共同教師的班級列表；記分等教學功能依後續任務提供。
...
- 已實作任務 01、01a、02、03、03a、04；記分與餵食依後續任務完成。
